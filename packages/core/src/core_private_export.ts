...
export {ReflectionCapabilities as ɵReflectionCapabilities, resetCtorCanonicalizer as ɵresetCtorCanonicalizer, setCtorCanonicalizer as ɵsetCtorCanonicalizer} from './reflection/reflection_capabilities';
